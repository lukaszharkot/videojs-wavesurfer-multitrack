# @lukaszharkot/videojs-wavesurfer-multitrack
...
```bash
npm install @lukaszharkot/videojs-wavesurfer-multitrack
```
...
import '@lukaszharkot/videojs-wavesurfer-multitrack/dist/videojs.wavesurfer.multitrack.js';
import '@lukaszharkot/videojs-wavesurfer-multitrack/dist/css/videojs.wavesurfer.multitrack.css';
